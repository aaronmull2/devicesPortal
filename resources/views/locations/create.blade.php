...
<form method="POST" action="/locations">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input class="form-control @error('address_line_1') is-invalid @enderror" type="text" name="address_line_1" id="address_line_1" value="{{ old('address_line_1') }}">  
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input class="form-control @error('city_town') is-invalid @enderror" type="text" name="city_town" id="city_town" value="{{ old('city_town') }}">  
        </div>
        @error('city_town')
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input class="form-control @error('county') is-invalid @enderror" type="text" name="county" id="county" value="{{ old('county') }}">  
        </div>
        @error('county')
    ...
    <div class="form-group">
        ...
        @error('postcode')
                <p class="text-danger">{{ $errors->first('potcode') }}</p>
        @enderror 
    </div>
    <div class="form-group">
